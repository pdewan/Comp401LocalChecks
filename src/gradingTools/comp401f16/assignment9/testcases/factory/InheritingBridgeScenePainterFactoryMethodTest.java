...
public class InheritingBridgeScenePainterFactoryMethodTest extends  FactoryMethodTest{
	public static final String[] FACTORY_METHOD_TAGS = 
			new String[] {"inheritingBridgeScenePainterFactoryMethod"};

	public InheritingBridgeScenePainterFactoryMethodTest() {
