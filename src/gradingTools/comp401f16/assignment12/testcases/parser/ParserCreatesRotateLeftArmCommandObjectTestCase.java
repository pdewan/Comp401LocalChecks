...
@MaxValue(5)
@IsExtra(true)
public class ParserCreatesRotateLeftArmCommandObjectTestCase 
	extends ParserCreatesApproachCommandObjectTestCase{
	
	protected Class commandObjectClass() {
		return RotateLeftArmCommandObjectTestCase.findRotateLeftArmCommandClass();
	}
	protected void setCommand() {
		setCommand("rotateLeftArm Arthur 20 ");
