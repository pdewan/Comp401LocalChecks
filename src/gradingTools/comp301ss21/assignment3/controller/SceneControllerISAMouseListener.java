...
@MaxValue(2)
public class SceneControllerISAMouseListener extends CheckstyleInterfaceDefinedTestCase {
...
//	[WARN] D:\dewan_backup\Java\grail13\.\src\greeting\Cls.java:6: Missing signature main:String[]->void in type greeting.Cls:[@Comp301Tags.GREETING_MAIN]. [ExpectedSignatures]
	public SceneControllerISAMouseListener() {
		super("@Comp301Tags.BRIDGE_SCENE_CONTROLLER", "java.awt.event.MouseListener");
