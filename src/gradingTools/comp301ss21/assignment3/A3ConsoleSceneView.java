...
@RunWith(Suite.class)
@Suite.SuiteClasses({
	TaggedConsoleSceneView.class,
	ConsoleSceneViewGetsBridgeScene.class,
    ConsoleSceneViewRegistersWithLocatables.class,
    ConsoleSceneViewISAPropertyChangeListener.class,
    ConsoleSceneViewPrintsPropertyChangeEvent.class,
...
@MaxValue(10)
public class A3ConsoleSceneView {
