...
@MaxValue(2)
public class PaintListenerISAPropertyChangeListener extends CheckstyleInterfaceDefinedTestCase {
...
//	[WARN] D:\dewan_backup\Java\grail13\.\src\greeting\Cls.java:6: Missing signature main:String[]->void in type greeting.Cls:[@Comp301Tags.GREETING_MAIN]. [ExpectedSignatures]
	public PaintListenerISAPropertyChangeListener() {
		super("Comp301Tags\\.PAINT_LISTENER", "java.beans.PropertyChangeListener");
