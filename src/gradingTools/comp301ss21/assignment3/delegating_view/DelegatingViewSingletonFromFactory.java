...
@MaxValue(2)
public class DelegatingViewSingletonFromFactory  extends BridgeSceneMoveTestCase{
	String[] factoryClassTags = new String[] {Comp301Tags.FACTORY_CLASS};

	public static final String[] FACTORY_METHOD_TAGS = new String[] {"delegatingBridgeSceneViewFactoryMethod"};
	public DelegatingViewSingletonFromFactory() {
